...
def test_success_download_form(browser):
    ...
    time.sleep(5)
    assert_content_download_thank_you_page(browser,'Travel & Expense Management Report by Levvel Research','test@fyle.in','https://cdn2.hubspot.net/hubfs/3906991/Paystream%202018%20Travel%20and%20Expense%20Management%20report.pdf')
    browser.back()
